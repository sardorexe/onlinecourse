...
const Main = () => {
  ...
  return (
    <>
      {showModal ? <Modal closeModal={closeFunc} /> : ""}
        ...
        <section className="about-courses">
          <div className="course-text">
            ...
            <p className="about-desc">
              ...
              xizmatlaridan har kuni foydalanishga odatlandik. Internet turli
              xil insonlarni yagona maqsad bilan birlashishiga sabab bo’lmoqda.
              Hamma internet tarmog’idan biror turdagi axborot olishga harakat
              qiladi. Shunday vaqtlar keladiki, dasturlashni bilish inson uchun
              normal holatga aylanib qoladi. Ya’ni, dasturlash o’rganishimiz
              kerak bo’lgan asosiy ehtiyojlarimizdan biriga aylanadi.
            </p>
            <p className="about-desc">
          ...
          <div className="about-boxes reasons">
            <div className="box">
              ...
              <ul className="reasons-list">
                <li className="reason">
                  Yuqori kayfiyat, maksimal darajada soddalik bilan
                  tushuntirish, professional dasturchilar tomonidan darslar,
                  zamonaviy yondashuv.
                </li>
                <li className="reason">
                ...
                <li className="reason">
                  Real loyihalar bilan ishlash, ishga kirish va o’z
                  karyerangizni boshlashingiz uchun qo’shimcha maslahatlar.
                </li>
              </ul>
            </div>
            <div className="box">
